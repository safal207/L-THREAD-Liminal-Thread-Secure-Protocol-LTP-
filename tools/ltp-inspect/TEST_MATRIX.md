...
| B08 | trace | fixtures/minimal.frames.jsonl | fmt=json --pretty --quiet | 0/1 | `contract.version=1.0` |
| B09 | trace | fixtures/minimal.frames.jsonl | fmt=json --quiet | 0/1 | stdout does not contain `RESULT:` |
