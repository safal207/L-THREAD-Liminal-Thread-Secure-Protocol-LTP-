...
- Quick Verification — `tools/conformance-kit/`

## Protocol
- Core Specification — `specs/`
...
- Non-Goals as Design Constraints (Why LTP Cannot Be Extended) — `docs/canon/LTP-Non-Goals-as-Design-Constraints.md`
