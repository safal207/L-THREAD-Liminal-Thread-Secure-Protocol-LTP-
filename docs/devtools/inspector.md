...
- Core constraints in `docs/canon/LTP-Non-Goals-as-Design-Constraints.md` forbid inference, goal synthesis, or heuristic adaptation inside LTP. Inspector exists to demonstrate those invariants, not to compensate for them.
