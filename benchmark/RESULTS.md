...
| drift-30-browser-agent-weak-cache-support | drift | drift | PASS | weak_anchor_support |
| drift-31-coding-agent-partial-ci-window | drift | drift | PASS | partial_provenance_chain |
| drift-31-coding-agent-weak-ci-support | drift | drift | PASS | weak_anchor_support |
| drift-32-fintech-weak-audit-link | drift | drift | PASS | weak_anchor_support |
...
| drift-33-legal-partial-review-note | drift | drift | PASS | partial_provenance_chain |
| drift-34-legal-partial-review-record | drift | drift | PASS | partial_provenance_chain |
| drift-34-sre-weak-postmortem-support | drift | drift | PASS | weak_anchor_support |
...
| rejected-34-browser-agent-unsupported-cache-claim | rejected | rejected | PASS | unsupported_intermediate_step |
| rejected-35-coding-agent-missing-ci-anchor | rejected | rejected | PASS | missing_anchor |
| rejected-35-coding-agent-unsupported-merge-step | rejected | rejected | PASS | unsupported_intermediate_step |
| rejected-36-fintech-anchor-mismatch-risk-threshold | rejected | rejected | PASS | anchor_mismatch |
...
| rejected-37-legal-broken-review-provenance | rejected | rejected | PASS | broken_provenance_chain |
| rejected-38-sre-missing-postmortem-anchor | rejected | rejected | PASS | missing_anchor |
| rejected-38-sre-missing-postmortem-approval | rejected | rejected | PASS | missing_required_approval |
