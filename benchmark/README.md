...
- mismatches: 0;
- expected labels: 33 admissible, 34 drift, 38 rejected.
...
The fixture set currently contains 105 cases total, including adversarial and boundary-condition coverage across all labels.
